        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrders_Bookings_BookingId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkOrders_ServiceTypes_ServiceTypeId",
                        column: x => x.ServiceTypeId,
                        principalTable: "ServiceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkOrders_Users_AssignedStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkOrderStageHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkOrderStageHistory_WorkOrders_WorkOrderId",
                        column: x => x.WorkOrderId,
                        principalTable: "WorkOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TenantId_ScheduledAt",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_AssignedStaffId",
                table: "WorkOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_ServiceTypeId",
                table: "WorkOrders",
                column: "ServiceTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_TenantId_Stage",
                table: "WorkOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderStageHistory_WorkOrderId",
                table: "WorkOrderStageHistory",
                column: "WorkOrderId");
        }
